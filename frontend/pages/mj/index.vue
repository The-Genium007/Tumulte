...
@@ -772,253 +67,11 @@ const { campaigns, fetchCampaigns, selectedCampaign, getCampaignMembers } = useC
...
@@ -1087,6 +141,9 @@ const launchSession = async (session: any) => {
    launchedPolls.value = [];
    ...
    toast.add({
      title: "Erreur",
@@ -1096,38 +153,6 @@ const launchSession = async (session: any) => {
  }
};
...
@@ -1139,7 +164,10 @@ const resetPollState = () => {
...
@@ -1154,7 +182,7 @@ const cancelPoll = async () => {
  if (pollStatus.value === 'sending') {
    try {
      const API_URL = import.meta.env.VITE_API_URL;
...
@@ -1184,7 +212,10 @@ const cancelPoll = async () => {
...
@@ -1194,45 +225,24 @@ const sendPoll = async () => {
  }
...
@@ -1258,7 +268,7 @@ const sendPoll = async () => {
  }
};
...
@@ -1278,27 +288,13 @@ const startCountdown = () => {
  }, 1000);
};
...
@@ -1309,7 +305,7 @@ const fetchPollResults = async () => {
    try {
...
@@ -1329,321 +325,26 @@ const fetchPollResults = async () => {
  }, 1000);
};
